...
2. Acesse a pasta:
   cd Entrega-do-Desafio


## Mitigação
  Força Bruta:
    Desativar FTP simples e usar SFTP
    Limitar tentativas de login
    Implementar bloqueio por IP
    Senhas fortes com política obrigatória
    MFA quando possível
  SMB:
    Política de senha forte
    Bloqueio após tentativas falhas
    Monitoramento de autenticações distribuídas
    Restringir SMB apenas à rede interna
    Auditoria de contas antigas ou inativas
